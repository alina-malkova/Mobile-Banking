...
\subsection{Phase 2: Static Multinomial Logit}

Table \ref{tab:structural_phase2} presents key parameters from the static multinomial logit estimation. The base alternative is Branch $\times$ Wage employment; coefficients represent log-odds relative to this baseline.
